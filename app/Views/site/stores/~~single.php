							...
							<div class="attributes">
								...
								?>
									...
									?>
										...
										<input type="hidden" name="attr[]" class="attr_hidden attr_hidden_<?php //print my_encrypt($attrkeys['id']);
																											?>" value="<?php //print my_encrypt($attrkeys['id']);
																																								?>_<?php //print my_encrypt($attrkeys['values'][0]['value_id']);
																																																			?>">
									<?php
									}
									?>
