...
<script type="text/javascript">
	...
	let colorsEven = ['#A01764', '#fadfae', '#A01764', '#fadfae'];
...
function addValuesResult()
{
	...
	if ( winpoerup == 1 ) {
		...
		var url = '<?php print base_url().'/compaign/play/'.$single['purl'].'/p/'.$single['pc'].'/'.'?sd_row='.$single['sd_row'].'&pds='.$single['pds'].'&playgive=1&wh=3';?>';
