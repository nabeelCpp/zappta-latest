						...
						<div class="col-md-12">
							...
							<div class="artaddForm">
								...
								<form method="post" action="<?php print base_url(); ?>/vendors/attributes/valueinsert" enctype="multipart/form-data">
									...
									<input type="hidden" name="_valueid" value="<?php print my_encrypt(0); ?>" />
									<input type="hidden" name="value_opt" value="<?php print isset($_GET['t']) ? $_GET['t'] : my_encrypt(1); ?>" />
									<div class="form-field">
										...
										<div class="field-input">
											<select class="form-control" name="attr_id">
												...
												?>
														<option value="<?php print my_encrypt($row['id']); ?>" <?php if ($row['id'] == my_decrypt($id)) { ?> selected<?php } ?>><?php print ucfirst($row['name_en']); ?></option>
												<?php
													}
												}
												?>
									...
									<?php if (isset($_GET['t']) && my_decrypt($_GET['t']) == 2) { ?>
										<div id="color_value" class="d-block">
											<div class="form-field position-relative">
												<label>Color Code</label>
												<div class="field-input">
													<input type="text" name="color_code" placeholder="000000" id="chosen-value" value="" />
												</div>
									...
									<div class="form-field">
										...
										<div class="field-input">
											<div class="form-check form-switch">
												<input class="form-check-input" id="formcheckinput" name="price_enable" type="checkbox" onclick="getCheckBox('formcheckinput');" value="1" />
									...
									<div id="priceblock">
										<div class="form-field">
											...
											<div class="field-input">
												<input type="text" name="price_value" value="" />
											</div>
										</div>
									</div>
									<div class="form-field">
										...
										<div class="btnCancel">
											<button type="button" onclick="window.location.href = '<?php print base_url() . '/vendors/attributes/values/' . $id . '/?t=' . $_GET['t']; ?>';">Cancel</button>
										</div>
									</div>
								</form>
