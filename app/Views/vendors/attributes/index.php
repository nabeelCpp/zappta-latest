						   	...
						   	<div class="row">
						      	<div class="col-md-12">
						      		<div class="attributes-links mt-4 mb-4">
						      			<div class="d-flexs">
							      			<a href="<?php print base_url().'/vendors/attributes/add'?>" class="addbtn float-end">
					      			...
					      			<div class="table-responsive product-list">
					      				<table class="table table-striped table-hover" id="attributes-data">
					      					<thead>
					      						<tr>
					      							<th><input type="checkbox" name="attributes-ids[]" /></th>
					      							<th>Name</th>
					      							<th>Values</th>
					      							<th>&nbsp;</th>
					      						</tr>
