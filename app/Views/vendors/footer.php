						...
						<div class="footer-search">
							<div class="d-flex">
								<div class="news-letter-footer d-flex">
									<input type="text" name="footer-news" id="footernews" placeholder="Your E-mail Address">
									<button type="button" class="btn footernewsbtn">Join now <i class="fa-solid fa-arrow-right-long"></i></button>
								</div>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
		var ValueUrl = '<?php if( count(getCurrentUrl()) == 4 && getCurrentUrl()[1] == 'attributes' && getCurrentUrl()[2] == 'values' ){ print getCurrentUrl()[3]; }?>';
</script>	
...
<script type="text/javascript" src="<?php print base_url();?>/theme/js/vendors/tiny_mce/tiny_mce.js"></script>
<script src="https://cdn.tiny.cloud/1/pcnklux0zj4aipov3irkzgbv189xq37vda3h3fqihvks67ok/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
...
<script src="<?php print base_url();?>/theme/js/vendors/dropzone/jquery.dm-uploader.min.js"></script>
<script src="<?php print base_url();?>/theme/js/vendors/dropzone/demo-ui.js"></script>
				  ...
				  <div class="tab-pane fade show active" id="nav-login" role="tabpanel" aria-labelledby="nav-login-tab">
				  		<div class="lg-social-login">
				  			<ul>
				  				...
				  				<li>
				  					<a href="" class="d-flex">
				  						<img src="<?php print base_url();?>/theme/image/sl-3.png" alt="" />
...
<div class="modal fade" id="galModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog  modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body" style="padding:10px;">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
						  <li class="nav-item" role="presentation">
						    <button class="nav-link active" id="galleryBlock-tab" data-bs-toggle="tab" data-bs-target="#galleryBlock" type="button" role="tab" aria-controls="galleryBlock" aria-selected="true">Gallery Image</button>
						  </li>
						  <li class="nav-item" role="presentation">
						    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Upload Gallery Image</button>
						  </li>
          </ul>
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="galleryBlock" role="tabpanel" aria-labelledby="galleryBlock-tab">
                <div class="row" id="gbb"></div>
                <div class="row" id="gbbfield"></div>
            </div>
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            					<input type="hidden" id="mediaGalleryUpload" name="<?php print csrf_token() ?>" value="<?php print csrf_hash() ?>">
                      <div class="row">
                        <div class="col"> 
                            <div class="input-group mb-3">
                                <div id="draganddropzoneGallery" class="dm-uploader p-5" style="width:100%;text-align:center;">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" id="addImage" class="btn btn-primary">Add</button>
      </div>
    </div>
  </div>
</div>
