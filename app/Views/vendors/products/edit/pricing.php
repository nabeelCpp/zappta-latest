		...
		<div class="form-row">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-3 col-12">
					...
					<div class="position-relative subtitle">
						<span class="position-absolute">$</span>
						<input type="text" name="product[detail][retail_price_tax]" id="p_regular_price" data-required="Regular price is required!" required class="form-control" placeholder="0.000000" value="<?php print $default['retail_price_tax'];?>" onkeyup="updateFinalPrice()">
					</div>
				</div>
				<div class="col-xl-3 col-lg-3 col-md-3 col-12">
