			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-12">
					...
					<div class="position-relative">
						<input type="text" name="product[seo][metatitle]" class="form-control" placeholder="To have a different title from the product name, enter it here." value="<?php print isset($default['meta_title']) ? $default['meta_title'] : '';?>">
					</div>
				</div>
				<div class="col-xl-12 col-lg-12 col-md-12 col-12 mt-3">
					...
					<div class="position-relative">
						<textarea name="product[seo][description]" class="form-control" placeholder="To have a different title from the product name, enter it here." maxlength="200"><?php print isset($default['meta_description']) ? $default['meta_description'] : '';?></textarea>
					</div>
				</div>
				<div class="col-xl-12 col-lg-12 col-md-12 col-12 mt-3">
					<label>
					...
					<div class="position-relative">
						<textarea name="product[seo][keywords]" class="form-control" placeholder="Meta keywords are meta tags that you can use to give search engines more information about a product content"><?php print isset($default['meta_keywords']) ? $default['meta_keywords'] : '';?></textarea>
