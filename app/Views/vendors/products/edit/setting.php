	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-12">
		<div class="form-row">
          ...
          <div class="row" id="product_image_block">
          	...
          	?>
          		<div class="col-md-3 mt-1 mb-1 pp_<?php print $x;?> <?php if( $default['cover'] == $gall['fimg'] ) { ?>active-cover<?php } ?>">
          			<div class="position-relative active_img_gallery">
          				...
          				<div class="ppgal" onclick="assignCover('<?php print $gall['fimg'];?>',<?php print $x;?>);">                                            
          					<img src="<?php print base_url();?>/images/product/<?php print $img_ext[0];?>/<?php print $img_ext[1];?>/250" alt="" class="rounded" style="height: 100px; width: 100%; object-fit: cover; object-position: center; cursor:pointer;">
          				</div>                                      
          			</div>
          		</div>
          	<?php
          	...
          	?>
          		...
          		<input type="hidden" name="product[default][cover]" id="productCover" value="<?php print $default['cover'];?>">
          </div>
          <div class="row"><div id="inputHidden"></div></div>
				</div>
			</div>
		</div>
		<!-- <div class="form-row">
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-12">
					<label>Summary</label>
					<textarea class="tinymce form-control" name="product[default][short]" maxlength="200"><?php //print $default['short'];?></textarea>
		 ...
		 --><div class="form-row">
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-12">
					...
					<textarea class="tinymce form-control" name="product[default][description]"><?php print $default['description'];?></textarea>
				</div>
			</div>
		</div>
		<div class="form-row">
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-12">
					...
					<textarea class="tinymce form-control" name="product[default][additional_details]"><?php print $default['additional_details'];?></textarea>
				</div>
			</div>
		</div>
		<div class="form-row">
			<div class="row">
				...
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					...
					<input type="text" data-required="SKU field is required" required name="product[default][reference]" class="form-control" value="<?php print $default['reference'];?>">
				</div>
			</div>
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					...
					<input type="text" name="product[default][isbn]" class="form-control" value="<?php print $default['isbn'];?>">
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					<label>
					...
					<input type="text" name="product[default][ean]" class="form-control" value="<?php print $default['ean'];?>">
				</div>
			</div>
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					...
					<input type="text" name="product[default][upcbarcode]" class="form-control" value="<?php print $default['upcbarcode'];?>">
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					<label>
					...
					<input type="text" name="product[default][mpncode]" class="form-control" value="<?php print $default['mpncode'];?>">
				</div>
			</div>
		</div>
