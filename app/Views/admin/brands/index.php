              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0 float-start" style="padding-top: 8px;">Brands</h6>
                    <?php if ( $perm->addp == 1 ) { ?>
                    	<a href="<?php print base_url();?>/admincp/brands/add" class="btn btn-info btn-sm float-end">Add</a>
                	<?php } ?>
                  			...
                  			?>
                  				<tr>
		                            ...
		                            <td><?php print $row['total_stores'];?></td>
						                    <td>
						                    <?php if ( $perm->editp == 1 ) { ?>
						                      <a href="<?php print base_url().'/admincp/brands/edit/'.my_encrypt($row['id']);?>" class="mb-2 btn btn-sm btn-success mr-1">
						                        Edit
						                      </a>
						                    <?php  } ?> 
						                    <?php if ( $perm->deletep == 1 ) { ?>
						                      <a href="<?php print base_url().'/admincp/brands/delete/'.my_encrypt($row['id']);?>" onclick="return confirm('Are you sure to delete this?');" class="mb-2 btn btn-sm btn-danger mr-1">
						                        Delete
						                      </a>
						                    <?php  } ?> 
						                    </td>
...
<script type="text/javascript">
  $(function(){
      $('#BrandsSearch').keyup(function(){
          ...
          $.ajax({
              url: '<?php print base_url().'/admincp/brands/search?word=';?>'+order_id,
              type: 'GET',
              datatype: 'JSON',
