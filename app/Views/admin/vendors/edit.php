                    ...
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <input type="number" min="0" class="form-control" name="earn_zappta" placeholder="Earn Zappta" value="<?=$users['earn_zappta']?$users['earn_zappta']:''?>">
                        </div>
                        <div class="col-md-6">
                          <label>Per Dollar</label>
                          <input type="number" min="0" class="form-control" name="per_dollar" placeholder="Per Dollar" value="<?=$users['per_dollar']?$users['per_dollar']:''?>">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
