		...
		<div class="row">
              ...
              <div class="card">
                <div class="card-body">
                	...
                	<form method="post" action="<?php print base_url().'/admincp/sliders/search/update';?>" enctype="multipart/form-data">
                		...
                		<div class="form-group">
                			...
                			<input type="text" name="name" placeholder="Slide Text" value="<?php print urldecode($file);?>" class="form-control" required />
                		</div>
