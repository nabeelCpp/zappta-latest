		...
		<div class="form-group">
			<div class="row">
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					...
					<input type="text" class="form-control" value="<?php print $default['quantity'];?>">
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					<label>
					...
					<input type="text" class="form-control" value="<?php print $default['min_qty'];?>">
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					...
					<input type="text" class="form-control" value="<?php print $default['low_qty'];?>">
				</div>
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					<label>
						<span class="tit">
							<input type="checkbox" value="1"<?php if( $default['stock_email'] == 1 ) {?> checked<?php }?>>
			...
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-6 col-12">
					<label class="form-check">
						<input type="radio" value="1" <?php if( $default['outofstockorder'] == 1 ) {?> checked<?php }?>>
						<span class="tit">Deny orders</span>
					</label>
					<label class="form-check">
						<input type="radio" value="2"<?php if(  $default['outofstockorder'] == 2 ) {?> checked<?php }?>>
